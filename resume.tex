...
\newcommand{\contactitem}[4]{%
  ...
  \href{#1}{%
    \fcolorbox{HeaderGreen!35}{white}{%
      \begin{tabular}{@{}c@{\hspace{0.35em}}l@{}}
        \raisebox{-0.15em}{\iconwithfallback{#2}{#3}} & {\small #4}
      \end{tabular}%
    }%
  }%
  \endgroup
...
\newcommand{\cvsection}[1]{%
  \vspace{0.55em}
  {\headingfont\large\color{HeaderGreen}\textbf{#1}}\par
  \vspace{0.18em}
  {\color{HeaderGreen}\rule{\linewidth}{0.6pt}}\par
  \vspace{0.2em}
}
...
\newcommand{\entrytitleline}[2]{%
  ...
  \begin{minipage}[t]{0.24\linewidth}
    \raggedleft {\small\color{MutedText} #2}
  \end{minipage}\par
}
...
\newcommand{\cvskill}[2]{%
  \item {\textbf{#1}: {\blurbfont #2}}
}

\begin{document}

\begin{center}
  {\headingfont\fontsize{27}{29}\selectfont\color{HeaderGreen}\textbf{Carter Rows}}\par
  \vspace{0.1em}
